    ...
    data() {
      return {
        ...
        links: [
          ...
          { title: 'Объявления', url: '/list', icon: 'mdi-view-list' },
          { title: 'Новое объявление', url: '/new', icon: 'mdi-plus' },
          { title: 'Вход', url: '/login', icon: 'mdi-login' },
          { title: 'Регистрация', url: '/registration', icon: 'mdi-account' },
          { title: 'Заказы', url: '/orders', icon: 'mdi-shopping' }
        ],
      };
    },
  };
